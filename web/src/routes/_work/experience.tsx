...
export const Route = createFileRoute("/_work/experience")({
  head: () => ({
    meta: [{ title: "Experience | Arshiya Sayyed" }],
  }),
  ...
  return (
    <main className="mx-auto w-full max-w-[920px] flex-1 px-6 py-14">
      ...
      <p className="mt-3 mb-10 max-w-lg text-claude-muted">
        Backend systems across ride-sharing, geospatial platforms, and healthcare, with a
        focus on APIs, reliability, and measurable impact.
      </p>
      <ExperienceTimeline />
    </main>
  )
